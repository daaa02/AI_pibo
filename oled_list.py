...
def o_suggestion():
    o.draw_image(openpibo.config['DATA_PATH'] + "/icon/화면_물음표1.png")    # 물음표2.png size error
    o.show()
...
def o_concil():
    o.draw_image(openpibo.config['DATA_PATH'] + "/icon/화면_default1.png")    # default2.png size error
    o.show()
