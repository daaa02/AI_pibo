...
def m_cheer():
    ...
    while True:
        ...
        time.sleep(0.4)
        o.set_motors(positions=[20, 0, 80, 0, 0, 0, 0, 0, -80, 20], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[0, 0, 80, 0, 0, 0, 0, 0, -80, 0], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[20, 0, 80, 0, 0, 0, 0, 0, -80, 20], movetime=500)
...
def m_compliment():
    ...
    while True:
        ...
        time.sleep(0.4)
        o.set_motors(positions=[20, 0, 0, 20, 0, 0, 0, 0, 0, 0], movetime=500)
        time.sleep(0.6)
...
def m_concil():
    o = Motion()
    while True:
        o.set_motors(positions=[0, 0, -45, 0, 10, 0, 0, 0, 45, 0], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[0, 0, -45, 0, -10, 0, 0, 0, 45, 0], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[0, 0, -45, 0, 10, 0, 0, 0, 45, 0], movetime=500)
        ...
        o.set_motors(positions=[0, 0, -45, 0, -10, 0, 0, 0, 45, 0], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[0, 0, 20, 0, 0, 0, 0, 0, -20, 0], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[0, 0, -45, 0, 0, 0, 0, 0, 45, 0], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[0, 0, 20, 0, 0, 0, 0, 0, -20, 0], movetime=500)
        time.sleep(0.6)
        o.set_motors(positions=[0, 0, -45, 0, 0, 0, 0, 0, 45, 0], movetime=500)
...
def m_tired():
    o = Motion()
    while True:
        o.set_motors(positions=[0, 0, -80, 10, 0, -5, 0, 0, 80, -10], movetime=1000)
        time.sleep(1.1)
        o.set_motors(positions=[0, 0, -80, -20, 0, 20, 0, 0, 80, 20], movetime=3000)
        time.sleep(1.6)
        o.set_motors(positions=[0, 0, -80, 20, 0, -5, 0, 0, 80, -20], movetime=300)
        time.sleep(0.4)
        o.set_motors(positions=[0, 0, -80, -20, 0, 20, 0, 0, 80, 20], movetime=3000)
        time.sleep(1.6)
        o.set_motors(positions=[0, 0, -80, 20, 0, -5, 0, 0, 80, -20], movetime=300)
